...
INSERT INTO SETTINGS SELECT 'MANUAL_ENTRY_PASSWORD', '123456' FROM DUAL WHERE NOT EXISTS (SELECT * FROM SETTINGS WHERE KEY = 'MANUAL_ENTRY_PASSWORD');
INSERT INTO SETTINGS SELECT 'EDIT_ENABLE_PASSWORD', '123456' FROM DUAL WHERE NOT EXISTS (SELECT * FROM SETTINGS WHERE KEY = 'EDIT_ENABLE_PASSWORD');
...
INSERT INTO SETTINGS SELECT 'indicatorCOMPort', 'Dummy' FROM DUAL WHERE NOT EXISTS (SELECT * FROM SETTINGS WHERE KEY = 'indicatorCOMPort');
...
INSERT INTO SETTINGS SELECT 'displayCOMPort', 'Dummy' FROM DUAL WHERE NOT EXISTS (SELECT * FROM SETTINGS WHERE KEY = 'displayCOMPort');

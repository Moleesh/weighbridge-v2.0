...
class Controller {
	...
	public @ResponseBody byte[] getPrintWeightPDF(@RequestBody PrintWeight printWeight) {
	...
	public @ResponseBody byte[] getReportPDF(@RequestBody PrintReport printReport) {
	...
	public @ResponseBody byte[] getImage(@RequestParam("webcam") String webcam) {

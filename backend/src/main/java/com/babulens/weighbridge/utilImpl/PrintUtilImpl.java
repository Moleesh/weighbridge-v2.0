...
public class PrintUtilImpl implements PrintUtil {
    ...
    public Book printMunicipalPrint(PrintWeight printWeight) {
        ...
        book.append((graphics, _, _) -> {
            ...
            graphics.setFont(new Font("Courier New", Font.BOLD, 12));
            drawStringAsColumn(graphics, "            " + StringUtils.leftPad("" + printWeight.getWeight().getGrossWeight(), 5, " "), margin, len - 2);
            graphics.setFont(new Font("Courier New", Font.PLAIN, 10));
            drawStringAsColumn(graphics, "TARE WT    : ", margin, len += height);
            graphics.setFont(new Font("Courier New", Font.BOLD, 12));
            drawStringAsColumn(graphics, "            " + StringUtils.leftPad("" + printWeight.getWeight().getTareWeight(), 5, " "), margin, len - 2);
            graphics.setFont(new Font("Courier New", Font.PLAIN, 10));
            drawStringAsColumn(graphics, "NET WT     : ", margin, len += height);
            graphics.setFont(new Font("Courier New", Font.BOLD, 12));
            drawStringAsColumn(graphics, "            " + StringUtils.leftPad("" + printWeight.getWeight().getNettWeight(), 5, " "), margin, len - 2);
            graphics.setFont(new Font("Courier New", Font.PLAIN, 10));

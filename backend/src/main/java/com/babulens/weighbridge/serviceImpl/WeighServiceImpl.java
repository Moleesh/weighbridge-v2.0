...
public class WeighServiceImpl implements WeighService {
    ...
    @Override
    public PrintWeightReport getWeightReportByProfile(Date startNettTime, Date endNettTime, String inputLabel, String input, String profile) {
        PrintWeightReport printWeightReport = new PrintWeightReport();
        int totalWeight = 0;
        int totalCharge = 0;
        switch (inputLabel) {
            case "Slip No":
                printWeightReport.setWeights(weightDAO.findAllBySlipNoGreaterThanEqualAndNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(Integer.parseInt(0 + input), startNettTime, endNettTime, profile));
                break;
            case "Customer Name":
                printWeightReport.setWeights(weightDAO.findAllByCustomersNameContainingAndNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(input, startNettTime, endNettTime, profile));
                break;
            case "Transporter Name":
                printWeightReport.setWeights(weightDAO.findAllByTransporterNameContainingAndNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(input, startNettTime, endNettTime, profile));
                break;
            case "Vehicle No":
                printWeightReport.setWeights(weightDAO.findAllByVehicleNoContainingAndNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(input, startNettTime, endNettTime, profile));
                break;
            case "Material":
                printWeightReport.setWeights(weightDAO.findAllByMaterialContainingAndNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(input, startNettTime, endNettTime, profile));
                break;
            default:
                printWeightReport.setWeights(weightDAO.findAllByNettTimeGreaterThanEqualAndNettTimeLessThanEqualAndProfileOrderBySlipNoAsc(startNettTime, endNettTime, profile));
                break;
        }
    ...
    @Override
    public Weight secondWeight(int slipNo, String profile) {
        Weight weight = weightDAO.findFirstBySlipNoAndProfileOrderBySlipNoDesc(slipNo, profile);
        Weight checkWeight = weightDAO.findFirstByVehicleNoAndProfileOrderBySlipNoDesc(weight.getVehicleNo(), profile);
